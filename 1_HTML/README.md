...
- week : 주에 대한 데이터를 입력받을 수 있다. (몇번 째 주인지 입력받을 수 있음)
...
8. tel : 전화번호를 입력받을 수 있따.

- 모바일 기기의 경우 키보드 배열이 전화번호를 입력받을 수 있도록 바뀐다.

## input 기본 속성

1. ulaceholder : 텍스트 입력에 도움이 되는 힌트를 표시
...
- HTML에서 주로 사용되는 의미가 없는 태그
- 다른 요소들을 그룹화하여 스타잉ㄹ을 적용하는데 사용
