function btn1() {
  /*
    ...
    - 두번쨰 : 창 이름, 창 이름이 같은게 이미 열려있을 경우 새로 열리지 않고 이미 열려있는 곳에서 새로고침
    - 세번째 : 새 창의 특성 (브라우저마다 적용범위 다름)
               - width : 창의 너비(px)
               - height : 창의 높이(px)
...
*/
  window.open(
    "https://www.naver.com",
    "네이버",
    "width=500, height=600, resizable=no, location=no, menuber=no, scrollbars=no, status=no, toolbar=no"
  );
}
